...
public:
    SimDao() {}
    void batchInsertSimulationResultsAndMetric(int, struct SimMetric, std::vector<struct SimResultStatus>&) {}
    void setSimStepAndTime(int, int, int) {}
    void setSimStatus(int, std::string) {}
};
}
